...
| CENTRAL_APISERVICEREVISIONPATTERN                                  | The naming pattern for APIServiceRevision Title. Date formats can be `{{date:YYYY/MM/DD}}, {{date:YYYY-MM-DD}}, {{MM/DD/YYYY}}, or {{date:MM-DD-YYYY}}`. Current default set to `{{APIServiceName}} - {{date:YYYY/MM/DD}} - r {{revision}}`.                                                                                                                                                                                                                                                       |
